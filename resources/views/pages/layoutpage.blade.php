                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="{{url('baiviet',['id'=>$posts->id])}}"><img style="height:200px;width:350px"
                                        src="{{asset('uploads/'.$posts->image)}}" alt="{{Str::slug($posts->title)}}"></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                                        <p class="post-date">MAY 10, 2018 / life</p>
                                        <a href="{{url('baiviet',['id'=>$posts->id])}}" class="post-title">
                                            <h4>{{$posts->title}}</h4>
                                        </a>
