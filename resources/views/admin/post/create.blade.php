...
<div class="main-container">
	...
	<div class="form-group">
		...
		<textarea class="form-control sm" name="short_description" placeholder="Mô tả ngắn"></textarea>
	</div>
    <div class="form-group">
		<label>Nội dung bài viết</label>
		<textarea class="form-control" name="description" placeholder="Nội dung"></textarea>
	</div>
	...
	<input type="submit"  name="themloaitintuc" class="btn btn-primary mt-2" value="Thêm bài viết">
</form>
                    </div>
				</div>
