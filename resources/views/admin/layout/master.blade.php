...
<html>
	<head>
		...
		<link
			...
			type="image/png"
			sizes="16x16"
			href="{{asset('admin/vendors/images/favicon-16x16.pngs')}}"
		/>
		...
		<div class="header">
			...
			<div class="header-right">
				<div class="user-notification">
					<a href="{{url('/')}}"><span class="micon bi bi-house">Trang Tin tức</span></a>
				</div>
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.html">
					...
					<img
						src="{{asset('admin/vendors/images/deskapp-logo-white.svg')}}"
						alt=""
						class="light-logo"
					/>
				</a>
				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="{{route('category.index')}}">Danh mục loại tin tức</a></li>
								<li><a href="{{route('post.index')}}">Danh mục bài viết</a></li>
							</ul>
						</li>
						<li>
						...
						<li>
							...
							>
								...
								<span class="mtext"
									>Landing Page
									<img src="{{asset('admin/vendors/images/coming-soon.png')}}" alt="" width="25"
								/></span>
							</a>
						</li>
					</ul>
